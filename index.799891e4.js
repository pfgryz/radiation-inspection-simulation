...
})({"6YEeu":[function(require,module,exports,__globalThis) {
...
var _graphics = require("./core/graphics");
var _parameters = require("./parameters");
var _cpm = require("./ui/cpm");
function start() {
    const canvas = document.getElementById("simulation");
    const parametersContainer = document.getElementById("parameters");
    const graphics = new (0, _graphics.Graphics)(canvas);
    const parameters = new (0, _parameters.Parameters)(parametersContainer);
    const simulation = new (0, _simulation.Simulation)(graphics, parameters);
...
},{"./simulation":"7v61t","./core/graphics":"eOQ7v","./parameters":"l23K6","./ui/cpm":"7AS3S"}],"7v61t":[function(require,module,exports,__globalThis) {
...
var _vector2 = require("./core/vector2");
var _ticksCounter = require("./ticksCounter");
var _radiation = require("./radiation");
const TimeoutMinimalDuration = 4;
class Simulation {
    constructor(graphics, parameters){
        this._graphics = graphics;
        this._parameters = parameters;
        this._tunnel = new (0, _tunnel.Tunnel)();
        this._rover = new (0, _rover.Rover)(this._tunnel.Road.Begin, this._tunnel.Road, parameters.Velocity, parameters.Angle);
        this._radiation = new (0, _radiation.Radiation)(this._parameters, this._tunnel.Accelerator);
        this._interval = null;
        this._alive = false;
        this._lastTick = Date.now();
        this._nextTicks = 0;
        this._lastFrame = 0;
        this._ticksCounter = new (0, _ticksCounter.TicksCounter)();
        this._graphics.Resize();
        this._graphics.Scale(1000, 200);
        this._graphics.Center();
        this._graphics.DrawText("Press [START]", new (0, _vector2.Vector2)(0, 0));
    }
    Start() {
        this._alive = true;
    ...
    Draw(force) {
        ...
        if (time - this._lastFrame > frameDuration || force) {
            ...
            this._graphics.DrawText("TPS: " + this._ticksCounter.TPS, new (0, _vector2.Vector2)(450, -200));
        }
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP","./rover":"6Heal","./tunnel":"YxX7A","./core/vector2":"ajjrI","./ticksCounter":"kKbmW","./radiation":"i7Dzw"}],"fD3PP":[function(require,module,exports,__globalThis) {
...
},{}],"6Heal":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Rover", ()=>Rover);
var _ref = require("./core/ref");
var _vector2 = require("./core/vector2");
var _shape = require("./core/shape");
var _helpers = require("./core/helpers");
class Rover {
    constructor(position, road, velocity, angle){
        this._shape = new (0, _shape.Shape)([
            new (0, _vector2.Vector2)(-1, 0.5),
            new (0, _vector2.Vector2)(0.5, 0.5),
            new (0, _vector2.Vector2)(1, 0),
            new (0, _vector2.Vector2)(0.5, -0.5),
            new (0, _vector2.Vector2)(-1, -0.5)
        ]).Scale(10);
        this._arrow = new (0, _shape.Shape)([
            new (0, _vector2.Vector2)(0, 0.1),
            new (0, _vector2.Vector2)(1.7, 0.1),
            new (0, _vector2.Vector2)(1.4, 0.3),
            new (0, _vector2.Vector2)(1.7, 0.3),
            new (0, _vector2.Vector2)(2.0, 0.0),
            new (0, _vector2.Vector2)(1.7, -0.3),
            new (0, _vector2.Vector2)(1.4, -0.3),
            new (0, _vector2.Vector2)(1.7, -0.1),
            new (0, _vector2.Vector2)(0, -0.1)
        ]).Scale(15);
        this._position = new (0, _ref.Ref)(position);
        this._roadPosition = new (0, _ref.Ref)(0);
        this._direction = new (0, _ref.Ref)(false);
        this._road = road;
    ...
    Update(time_delta) {
        ...
        if (changeDirection) this._direction.value = !this._direction.value;
        this._position.value = this._road.GetPosition(this._roadPosition.value);
    }
    Draw(graphics) {
        graphics.DrawShape(this._position.value, this._shape);
        graphics.Stroke();
        graphics.DrawShape(this._position.value, this._arrow.Rotate((0, _helpers.radians)(this._angle.value)));
        graphics.Fill();
    }
}

},{"./core/ref":"1pFbW","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP","./core/vector2":"ajjrI","./core/shape":"aWRwH","./core/helpers":"02pPt"}],"1pFbW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Ref {
    ...
    get value() {
        if (context.length > 0) this._subscriptions.add(context[context.length - 1]);
        return this._value;
    }
    set value(value) {
        this._value = value;
        for (let subscription of this._subscriptions)subscription();
    }
}
function ref(value) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"ajjrI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Vector2 {
    ...
    Rotate(reference, angle) {
        ...
        const rotated = new Vector2(offset.x * cosValue - offset.y * sinValue, offset.x * sinValue + offset.y * cosValue);
    ...
    Int(method = Math.round) {
        return new Vector2(method(this.x), method(this.y));
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"aWRwH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Shape {
    ...
    Scale(scale) {
        return new Shape(this.vertices.map((v)=>v.Scale(scale)));
    }
    Rotate(angle) {
        return new Shape(this.vertices.map((v)=>v.Rotate((0, _vector2.Vector2).Zero, angle)));
    }
}

},{"./vector2":"ajjrI","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"02pPt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"YxX7A":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Tunnel {
    ...
    Draw(graphics) {
        graphics.DrawShape((0, _vector2.Vector2).Zero, this._barrier);
        graphics.Stroke((0, _color.Color).Grey, 4);
        graphics.DrawLine(this._accelerator.Begin, this._accelerator.End);
        graphics.Stroke((0, _color.Color).Red, 4);
        graphics.DrawLine(this._road.Begin, this._road.End);
        graphics.Stroke((0, _color.Color).Blue, 1, [
            5,
            10
        ]);
    }
    constructor(){
        this._barrier = new (0, _shape.Shape)([
            new (0, _vector2.Vector2)(-500, 60),
            new (0, _vector2.Vector2)(500, 60),
            new (0, _vector2.Vector2)(500, -60),
            new (0, _vector2.Vector2)(-500, -60)
        ]);
        this._accelerator = new (0, _road.Road)(new (0, _vector2.Vector2)(-475, 30), new (0, _vector2.Vector2)(475, 30));
        this._road = new (0, _road.Road)(new (0, _vector2.Vector2)(-450, -10), new (0, _vector2.Vector2)(350, -10));
    }
}

},{"./core/shape":"aWRwH","./core/vector2":"ajjrI","./core/color":"j6DDp","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP","./road":"lR9ZY"}],"j6DDp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"lR9ZY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Road {
    ...
    NextPosition(position, delta) {
        if (position + delta > this._length) return [
            2 * this._length - position - delta,
            true
        ];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"kKbmW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TicksCounter", ()=>TicksCounter);
class TicksCounter {
    constructor(){
        this._interval = null;
        this._tps = 0;
    ...
    Start() {
        if (this._interval == null) this._interval = setInterval(()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"i7Dzw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Radiation", ()=>Radiation);
var _source = require("./source");
var _heatmap = require("./ui/heatmap");
var _vector2 = require("./core/vector2");
class Radiation {
    constructor(parameters, accelerator){
        this._first = new (0, _source.Source)(parameters.FirstSource, parameters.FirstSourceIntensity, accelerator);
        this._second = new (0, _source.Source)(parameters.SecondSource, parameters.SecondSourceIntensity, accelerator);
        this._heatmap = new (0, _heatmap.Heatmap)(new (0, _vector2.Vector2)(-500, -100), new (0, _vector2.Vector2)(500, 100), new (0, _vector2.Vector2)(100, 20));
    }
    Draw(graphics) {
...
},{"./source":"d53aK","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP","./ui/heatmap":"5fW31","./core/vector2":"ajjrI"}],"d53aK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Source", ()=>Source);
class Source {
    constructor(position, intensity, accelerator){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"5fW31":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Heatmap", ()=>Heatmap);
var _color = require("../core/color");
class Heatmap {
    constructor(from, to, resolution){
        this._from = from;
        this._to = to;
        ...
        for(let row = 0; row < resolution.y; row++){
            this._data[row] = [];
            for(let column = 0; column < resolution.x; column++)this._data[row][column] = 0;
        }
    }
    Draw(graphics) {
        ...
        for(let row = 0; row < this._resolution.y; row++){
            ...
            for(let column = 0; column < this._resolution.x; column++){
                ...
                graphics.DrawRectangle(position, size.x, size.y);
                if (value == 0) {
                    graphics.Fill((0, _color.Color).Blue);
                    graphics.Stroke((0, _color.Color).Blue);
                } else {
                    graphics.Fill((0, _color.Color).Red);
                    graphics.Stroke((0, _color.Color).Red);
                }
                position.x += size.x;
            }
            position.y += size.y;
...
},{"../core/color":"j6DDp","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"eOQ7v":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Graphics {
    ...
    DrawRectangle(from, width, height) {
        this._context.beginPath();
        this._context.moveTo(from.x, from.y);
    ...
    DrawShape(position, shape) {
        ...
        for (let vertex of shape.vertices)this._context.lineTo(vertex.x + position.x, vertex.y + position.y);
    ...
    // endregion
    // region Filling
    Fill(style = (0, _color.Color).Black) {
        this._context.fillStyle = style;
        this._context.fill();
    }
    Stroke(style = (0, _color.Color).Black, width = 1, dashStyle = []) {
...
},{"./color":"j6DDp","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"l23K6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Parameters", ()=>Parameters);
var _ref = require("./core/ref");
var _numberParameter = require("./core/parameters/number_parameter");
class Parameters {
    constructor(container){
        this.OnStart = new (0, _ref.Ref)(()=>{});
        this.OnStop = new (0, _ref.Ref)(()=>{});
        this.OnStep = new (0, _ref.Ref)(()=>{});
        this.OnReset = new (0, _ref.Ref)(()=>{});
        ...
        this._fps_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="fps"]')[0], {
            Min: 1,
            Max: 60,
            Step: 1,
            Default: 60
        }, "FPS");
        this._tps_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="tps"]')[0], {
            Min: 1,
            Max: 1000,
            Step: 1,
            Default: 100
        }, "TPS");
        this._speed_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="speed"]')[0], {
            Min: 0.1,
            Max: 100,
            Step: 0.1,
            Default: 1
        }, "Simulation Speed", (s)=>`x${s}`);
        this._velocity_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="velocity"]')[0], {
            Min: 0,
            Max: 6,
            Step: 0.1,
            Default: 1
        }, null, (s)=>`${s} m/s`);
        this._angle_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="angle"]')[0], {
            Min: 0,
            Max: 360,
            Step: 1,
            Default: 0
        }, null, (s)=>`${s}\xb0`);
        this._first_source_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="first-source"]')[0], {
            Min: 0,
            Max: 1,
            Step: 0.01,
            Default: 0.3
        }, null, (s)=>`${s}`);
        this._first_source_intensity_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="first-source-intensity"]')[0], {
            Min: 0,
            Max: 10000,
            Step: 1,
            Default: 0
        }, null, (s)=>`${s}`);
        this._second_source_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="second-source"]')[0], {
            Min: 0,
            Max: 1,
            Step: 0.01,
            Default: 0.7
        }, null, (s)=>`${s}`);
        this._second_source_intensity_parameter = new (0, _numberParameter.NumberParameter)(container.querySelectorAll('[data-parameter-name="second-source-intensity"]')[0], {
            Min: 0,
            Max: 10000,
            Step: 1,
            Default: 0
    ...
    get FirstSourceIntensity() {
        return this._first_source_intensity_parameter.Value;
    }
    get SecondSource() {
        return this._second_source_parameter.Value;
    }
    get SecondSourceIntensity() {
        return this._second_source_intensity_parameter.Value;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP","./core/parameters/number_parameter":"40izK","./core/ref":"1pFbW"}],"40izK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "NumberParameter", ()=>NumberParameter);
var _ref = require("../ref");
var _helpers = require("../helpers");
class NumberParameter {
    constructor(container, { Min = 0, Max = 1, Step = 0.1, Default = 0 }, title = null, format){
        const id = container.getAttribute("data-parameter-name");
        const label = document.createElement("label");
        label.htmlFor = id;
        label.innerText = title || `${(0, _helpers.capitalize)(id)}:`;
        ...
        this._value = new (0, _ref.Ref)(parseFloat(this._input.value));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP","../ref":"1pFbW","../helpers":"02pPt"}],"7AS3S":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initChart() {
    let chart = new (0, _chart.UIChart)(document.getElementById("cpm-chart"), {
        label: "CPM",
        xTitle: "Time",
        yTitle: "CPM"
    });
...
},{"./chart":"8MKOn","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"8MKOn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UIChart", ()=>UIChart);
var _chartJs = require("chart.js");
(0, _chartJs.Chart).register((0, _chartJs.CategoryScale), (0, _chartJs.LinearScale), (0, _chartJs.LineElement), (0, _chartJs.LineController), (0, _chartJs.PointElement), (0, _chartJs.Title), (0, _chartJs.Tooltip), (0, _chartJs.Legend));
class UIChart {
    constructor(canvas, { label, color = 'rgba(75, 192, 192, 1)', xTitle, yTitle }){
        this._canvas = canvas;
        this._context = this._canvas.getContext("2d");
        this._chart = new (0, _chartJs.Chart)(this._context, {
            type: "line",
            data: {
                labels: [],
                datasets: [
...
},{"chart.js":"3G2Tu","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"3G2Tu":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.4.7
...
},{"./chunks/helpers.segment.js":"7RJ09","@kurkle/color":"aE5Ah","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"7RJ09":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.4.7
 * https://www.chartjs.org
 * (c) 2024 Chart.js Contributors
...
},{"@kurkle/color":"aE5Ah","@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}],"aE5Ah":[function(require,module,exports,__globalThis) {
/*!
 * @kurkle/color v0.3.4
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD3PP"}]},["6YEeu","h7u1C"], "h7u1C", "parcelRequire94c2")
